...
extern void F968_7879(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 0, 0, 13582);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F968_7879 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 967, Current, 0, 7878);
	RTSA(dtype);
	RTME(dtype, 0);
