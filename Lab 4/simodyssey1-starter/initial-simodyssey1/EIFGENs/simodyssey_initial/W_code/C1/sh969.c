...
extern EIF_TYPED_VALUE F969_7275(EIF_REFERENCE);
extern void F969_7879(EIF_REFERENCE, int);
...
RTOID (F969_7275)
EIF_TYPED_VALUE F969_7275 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 968, Current, 0, 0, 13584);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F969_7879 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 968, Current, 0, 7878);
	RTSA(dtype);
	RTME(dtype, 0);
