...
extern EIF_TYPED_VALUE F963_7241(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F963_7877(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F963_7241 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 962, Current, 2, 2, 13546);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F963_7877 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 962, Current, 0, 7876);
	RTSA(dtype);
	RTME(dtype, 0);
